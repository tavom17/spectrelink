 ...
 */
export declare function getDefaultLamportsEncoder(): FixedSizeEncoder<Lamports | Sol, 8>;
/**
 ...
 * ```
 */
export declare function getLamportsEncoder<TEncoder extends NumberEncoder>(innerEncoder: TEncoder): Encoder<Lamports | Sol> & ExtractAdditionalProps<TEncoder, NumberEncoder>;
/**
 ...
 */
export declare function getDefaultLamportsCodec(): FixedSizeCodec<Lamports | Sol, Lamports, 8>;
/**
 ...
 */
export declare function getLamportsCodec<TCodec extends NumberCodec>(innerCodec: TCodec): Codec<Lamports | Sol, Lamports> & ExtractAdditionalProps<TCodec, NumberCodec>;
export {};
