import { type FixedPointToStringOptions } from '../formatting';
 ...
 */
export declare function decimalFixedPointToString(value: DecimalFixedPoint<Signedness, number, number>, options?: FixedPointToStringOptions): string;
/**
 ...
 */
export declare function formatDecimalFixedPoint(formatter: Intl.NumberFormat, value: DecimalFixedPoint<Signedness, number, number>): string;
/**
 ...
 * @see {@link decimalFixedPointToString}
 */
export declare function decimalFixedPointToNumber(value: DecimalFixedPoint<Signedness, number, number>): number;
