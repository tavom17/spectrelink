 ...
 */
export declare function toUnsignedDecimalFixedPoint<TTotalBits extends number, TDecimals extends number>(value: DecimalFixedPoint<Signedness, TTotalBits, TDecimals>): DecimalFixedPoint<'unsigned', TTotalBits, TDecimals>;
/**
 ...
 */
export declare function toSignedDecimalFixedPoint<TTotalBits extends number, TDecimals extends number>(value: DecimalFixedPoint<Signedness, TTotalBits, TDecimals>): DecimalFixedPoint<'signed', TTotalBits, TDecimals>;
/**
 ...
 * @see {@link toUnsignedDecimalFixedPoint}
 */
export declare function rescaleDecimalFixedPoint<TSignedness extends Signedness, TNewTotalBits extends number, TNewDecimals extends number>(value: DecimalFixedPoint<TSignedness, number, number>, newTotalBits: TNewTotalBits, newDecimals: TNewDecimals, rounding?: RoundingMode): DecimalFixedPoint<TSignedness, TNewTotalBits, TNewDecimals>;
