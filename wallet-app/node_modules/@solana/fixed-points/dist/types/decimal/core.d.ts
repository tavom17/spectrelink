 ...
 */
export declare function decimalFixedPoint<TSignedness extends Signedness, TTotalBits extends number, TDecimals extends number>(signedness: TSignedness, totalBits: TTotalBits, decimals: TDecimals): (input: string, rounding?: RoundingMode) => DecimalFixedPoint<TSignedness, TTotalBits, TDecimals>;
/**
 ...
 * @see {@link ratioDecimalFixedPoint}
 */
export declare function rawDecimalFixedPoint<TSignedness extends Signedness, TTotalBits extends number, TDecimals extends number>(signedness: TSignedness, totalBits: TTotalBits, decimals: TDecimals): (raw: bigint) => DecimalFixedPoint<TSignedness, TTotalBits, TDecimals>;
/**
 * Returns a factory that constructs {@link DecimalFixedPoint} values from
 ...
 * @see {@link rawDecimalFixedPoint}
 */
export declare function ratioDecimalFixedPoint<TSignedness extends Signedness, TTotalBits extends number, TDecimals extends number>(signedness: TSignedness, totalBits: TTotalBits, decimals: TDecimals): (numerator: bigint, denominator: bigint, rounding?: RoundingMode) => DecimalFixedPoint<TSignedness, TTotalBits, TDecimals>;
