 ...
 */
export declare function binaryFixedPointToString(value: BinaryFixedPoint<Signedness, number, number>, options?: FixedPointToStringOptions): string;
/**
 ...
 */
export declare function formatBinaryFixedPoint(formatter: Intl.NumberFormat, value: BinaryFixedPoint<Signedness, number, number>): string;
/**
 ...
 * @see {@link binaryFixedPointToString}
 */
export declare function binaryFixedPointToNumber(value: BinaryFixedPoint<Signedness, number, number>): number;
