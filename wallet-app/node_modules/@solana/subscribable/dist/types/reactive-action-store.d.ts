 ...
 * @see {@link ReactiveActionStore}
 */
export declare function createReactiveActionStore<TArgs extends readonly unknown[], TResult>(fn: (signal: AbortSignal, ...args: TArgs) => Promise<TResult>): ReactiveActionStore<TArgs, TResult>;
//# sourceMappingURL=reactive-action-store.d.ts.map