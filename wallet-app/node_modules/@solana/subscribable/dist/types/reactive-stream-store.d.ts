 ...
 */
export declare function createReactiveStoreFromDataPublisher<TData>({ abortSignal, dataChannelName, dataPublisher, errorChannelName, }: Config): ReactiveStreamStore<TData>;
/**
 ...
 * ```
 */
export declare function createReactiveStoreFromDataPublisherFactory<TData>({ abortSignal, createDataPublisher, dataChannelName, errorChannelName, }: FactoryConfig): ReactiveStreamStore<TData>;
export {};
